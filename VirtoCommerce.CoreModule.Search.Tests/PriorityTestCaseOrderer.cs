...
namespace VirtoCommerce.CoreModule.Search.Tests
{
    ...
    {
        public const string TypeName = "VirtoCommerce.CoreModule.Search.Tests.PriorityTestCaseOrderer";
        public const string AssembyName = "VirtoCommerce.CoreModule.Search.Tests";
