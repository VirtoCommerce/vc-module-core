...
"%MSBUILD_PATH%" "%SOURCE_DIR%\VirtoCommerce.Tools.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"

nuget pack "%SOURCE_DIR%\VirtoCommerce.Tools\VirtoCommerce.Tools.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
