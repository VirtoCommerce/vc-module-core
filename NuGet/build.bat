...
nuget pack "%SOURCE_DIR%\VirtoCommerce.CoreModule.Client\VirtoCommerce.CoreModule.Client.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
