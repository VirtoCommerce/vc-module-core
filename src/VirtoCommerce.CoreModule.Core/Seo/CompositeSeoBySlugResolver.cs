...
{
    [Obsolete("Use VirtoCommerce.Seo.Core.Services.CompositeSeoResolver", DiagnosticId = "VC0010", UrlFormat = "https://docs.virtocommerce.org/products/products-virto3-versions/")]
