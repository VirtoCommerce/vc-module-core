...
namespace VirtoCommerce.CoreModule.Data.Repositories
{
    public class CoreDbContext : DbContextWithTriggers
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NumberGeneratorDescriptorEntity>().ToTable("NumberGeneratorDescriptor").HasKey(x => x.Id);
            modelBuilder.Entity<NumberGeneratorDescriptorEntity>().Property(x => x.Id).HasMaxLength(128).ValueGeneratedOnAdd();
            modelBuilder.Entity<NumberGeneratorDescriptorEntity>().Property(x => x.CreatedBy).HasMaxLength(64);
            modelBuilder.Entity<NumberGeneratorDescriptorEntity>().Property(x => x.ModifiedBy).HasMaxLength(64);
